		...
		<div className='flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 sm:gap-8 my-12 pt-8 border-t border-gray-200'>
			{prevArticle ? (
				<Link
					...
					className='flex items-center gap-2 text-gray-600 hover:text-pink-500 transition-colors flex-1 min-w-0'
				>
			...
			{nextArticle ? (
				<Link
					...
					className='flex items-center gap-2 text-gray-600 hover:text-pink-500 transition-colors flex-1 min-w-0 text-right max-sm:self-end'
				>
					<div className='flex flex-col min-w-0'>
						<span className='text-xs sm:text-sm text-gray-500'>
							Next Article
